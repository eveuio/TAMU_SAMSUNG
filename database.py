...
#?-------------------------CORE-DATABASE-FUNCTIONS-------------------------------#
    ...
    def addTransformer(self):
        ...
        #TODO: Rated Values (transformer specs) for Transformer
    ...
    def createAverageReport(self,transformer):
        ...
        #     transformerData.columns[9]: 'avg_vTHD_a_phase',                         # EMPTY
        #     transformerData.columns[10]: 'avg_vTHD_b_phase',                        # EMPTY
        #     transformerData.columns[11]: 'avg_vTHD_c_phase',                        # EMPTY
        #     transformerData.columns[12]: 'avg_vTHD_total_phase',                    # EMPTY
        #     transformerData.columns[13]: 'avg_power_factor',                        # EMPTY
        ...
        rename_map = {
            ...
            'DATETIME': 'datetime',
            f'MCCB_{transformer.name}_V_AB_AVG': 'avg_secondary_voltage_a_phase',
            f'MCCB_{transformer.name}_V_BC_AVG': 'avg_secondary_voltage_b_phase',
            f'MCCB_{transformer.name}_V_CA_AVG': 'avg_secondary_voltage_c_phase',
            'V_RMS': 'avg_secondary_voltage_total_phase',
            f'MCCB_{transformer.name}_I_A_AVG': 'avg_secondary_current_a_phase',
            f'MCCB_{transformer.name}_I_B_AVG': 'avg_secondary_current_b_phase',
            f'MCCB_{transformer.name}_I_C_AVG': 'avg_secondary_current_c_phase',
            'I_RMS': 'avg_secondary_current_total_phase',
            f'LTR_{transformer.name}_TEMP_WL_AVG': 'avg_winding_temp_a_phase',
            f'LTR_{transformer.name}_TEMP_WC_AVG': 'avg_winding_temp_b_phase',
            f'LTR_{transformer.name}_TEMP_WR_AVG': 'avg_winding_temp_c_phase',
